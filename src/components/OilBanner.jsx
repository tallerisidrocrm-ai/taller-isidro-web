    ...
    return (
        <section style={{ backgroundColor: 'var(--accent-color)', padding: '25px 0' }}>
            <div className="container insurance-banner-content">
                ...
                <button onClick={() => window.open('https://wa.me/5491159722457?text=Hola,%20quisiera%20turno%20para%20cambio%20de%20aceite', '_blank')} className="btn" style={{ backgroundColor: '#000', color: '#fff', border: 'none' }}>
                    Pedir Turno
                </button>
            </div>
        </section>
