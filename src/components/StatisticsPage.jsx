                    ...
                    <div className="kpi-grid">
                        <div className="kpi-card">
                            <div className="kpi-icon-row">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--stat-accent)' }}>
                                    <path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.5 2.1C2.1 10.1 2 10.1 2 10.1V16c0 .6.4 1 1 1h2m10 0h4"></path>
                        ...
                        <div className="kpi-card" style={{ borderColor: 'rgba(59, 130, 246, 0.3)' }}>
                            <div className="kpi-icon-row">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--stat-info)' }}>
                        ...
                        <div className="kpi-card" style={{ borderColor: 'rgba(234, 179, 8, 0.3)' }}>
                            <div className="kpi-icon-row">
