    ...
    return (
        <section style={{ backgroundColor: 'var(--accent-color)', padding: '25px 0' }}>
            <div className="container insurance-banner-content">
                ...
                <button onClick={() => window.open('https://wa.me/5491159722457?text=Hola,%20necesito%20una%20inspección%20para%20el%20seguro', '_blank')} className="btn" style={{ backgroundColor: '#000', color: '#fff', border: 'none' }}>
